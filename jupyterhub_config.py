...
#c.JupyterHub.data_files_path = '/opt/python/python3.6.7/share/jupyterhub'
...
## The ip or hostname for proxies and getners to use for connecting to the Hub.
#  
...
import batchspawner
c.JupyterHub.spawner_class = 'batchspawner.GridengineSpawner'
...
c.GridengineSpawner.req_queue = 'short'
# Bedzie aktualne w nadchodzacej wersji 0.9
#c.GridengineSpawner.exec_prefix = 'export SGE_ROOT=/usr/local/sge; export SGE_CELL=blueocean-v15;'

c.GridengineSpawner.batch_query_cmd = 'sudo -E -u {username} -- bash -c "source /etc/profile.d/sge.sh; export PATH SGE_ROOT SGE_CELL; qstat -xml"'
c.GridengineSpawner.batch_cancel_cmd = 'sudo -E -u {username} -- bash -c "source /etc/profile.d/sge.sh; export PATH SGE_ROOT SGE_CELL; qdel {job_id}"'
c.GridengineSpawner.batch_submit_cmd = 'sudo -E -u {username} -- bash -c "source /etc/profile.d/sge.sh; export PATH SGE_ROOT SGE_CELL; qsub -q {queue}"'
